...
module.exports = "<div class=\"container\">\n  <h1>Add Task</h1>\n  <h4><a [routerLink]=\"['/taskmanager']\">Go Back</a></h4>\n  <div class=\"row\">\n    <div class=\"col-md-6\">\n      <form  #addTaskForm=\"ngForm\">\n        <div class=\"form-group\">\n          <label for=\"name\">Task</label>\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"task.taskName\" name=\"name\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"priority\">Priority</label><br/>\n\t\t  0<input type=\"range\" [(ngModel)]=\"task.priority\" min=\"0\" max=\"100\" data-show-value=\"true\" name=\"priority\" required=\"true\"/>100\n        </div>\n      \n        <div class=\"form-group\">\n          <label for=\"startDate\">Start Date</label>\n          <input type=\"date\" class=\"form-control\" [(ngModel)]=\"task.startDate\" name=\"startDate\" required>\n        </div>\n\t\t\n\t\t<div class=\"form-group\">\n\t\t <label for=\"parentTask\">Parent</label>\n\t\t  <input type=\"text\" class=\"form-control\" [(ngModel)]=\"task.parentTaskName\" name=\"parentTask\">\n\t\t</div>\n       \n        <div class=\"form-group\">\n          <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!addTaskForm.form.valid\" (click) =\"saveTask()\">Save</button>\n\t\t  <button type=\"reset\" class=\"btn btn-success\" [disabled]=\"!addTaskForm.form.valid\" (click) =\"resetTask(addTaskForm)\">Reset</button>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>"
...
var AddtaskComponent = /** @class */ (function () {
    ...
    AddtaskComponent.prototype.saveTask = function () {
        ...
        this.http.post('/tasks', this.task)
            ...
            _this.router.navigate(['/taskmanager', res]);
        }, function (err) {
            console.log(err);
        });
    };
    AddtaskComponent.prototype.resetTask = function (addTaskForm) {
...
/* harmony import */ var _taskmanager_taskmanager_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./taskmanager/taskmanager.component */ "./src/app/taskmanager/taskmanager.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _addtask_addtask_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./addtask/addtask.component */ "./src/app/addtask/addtask.component.ts");
...
var appRoutes = [
    {
        path: 'taskmanager',
        component: _taskmanager_taskmanager_component__WEBPACK_IMPORTED_MODULE_4__["TaskmanagerComponent"],
        data: { title: 'Task Manager' }
    },
    {
        path: 'addtask',
        component: _addtask_addtask_component__WEBPACK_IMPORTED_MODULE_8__["AddtaskComponent"],
        data: { title: 'Add Task' }
    },
    {
        path: 'edittask/:id',
    ...
    {
        path: 'viewtask/:id',
        component: _viewtask_viewtask_component__WEBPACK_IMPORTED_MODULE_12__["ViewtaskComponent"],
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _taskmanager_taskmanager_component__WEBPACK_IMPORTED_MODULE_4__["TaskmanagerComponent"],
                _addtask_addtask_component__WEBPACK_IMPORTED_MODULE_8__["AddtaskComponent"],
...
module.exports = "<div class=\"container\">\n  <h1>Edit Task</h1>\n  <h4><a [routerLink]=\"['/taskmanager']\">Go Back</a></h4>\n  <div class=\"row\">\n    <div class=\"col-md-6\">\n      <form  #editTaskForm=\"ngForm\">\n        <div class=\"form-group\">\n          <label for=\"name\">Task</label>\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"task.taskName\" name=\"name\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"priority\">Priority</label>\n\t\t  0<input type=\"range\" [(ngModel)]=\"task.priority\" min=\"0\" max=\"100\" data-show-value=\"true\" name=\"priority\" required=\"true\"/>100\n        </div>\n      \n        <div class=\"form-group\">\n          <label for=\"startDate\">Start Date</label>\n          <input type=\"date\" class=\"form-control\" [(ngModel)]=\"task.startDate\" name=\"startDate\" required>\n        </div>\n\t\t\n\t\t<div class=\"form-group\">\n\t\t <label for=\"parentTask\">Parent</label>\n\t\t  <input type=\"text\" class=\"form-control\" [(ngModel)]=\"task.parentTaskName\" name=\"parentTask\">\n\t\t</div>\n       \n        <div class=\"form-group\">\n          <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!editTaskForm.form.valid\" (click) =\"updateTask(task.id)\">Update</button>\n\t\t  <button type=\"reset\" class=\"btn btn-success\" [disabled]=\"!editTaskForm.form.valid\" (click) =\"retrieveOldTask()\">Cancel</button>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>"
...
var EdittaskComponent = /** @class */ (function () {
    ...
    EdittaskComponent.prototype.getTask = function (id) {
        ...
        this.http.get('/tasks/' + id).subscribe(function (data) {
            _this.task = data;
            _this.updateStartDateFormat(_this.task);
        });
    };
    EdittaskComponent.prototype.updateStartDateFormat = function (task) {
    ...
    EdittaskComponent.prototype.retrieveOldTask = function () {
        this.getTask(this.route.snapshot.params['id']);
    };
    EdittaskComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"]])
    ], EdittaskComponent);
...
/***/ "./src/app/taskmanager/taskmanager.component.css":
/*!*******************************************************!*\
  !*** ./src/app/taskmanager/taskmanager.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Rhc2ttYW5hZ2VyL3Rhc2ttYW5hZ2VyLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/taskmanager/taskmanager.component.html":
/*!********************************************************!*\
  !*** ./src/app/taskmanager/taskmanager.component.html ***!
  \********************************************************/
/*! no static exports found */
...
var TaskmanagerComponent = /** @class */ (function () {
    function TaskmanagerComponent(http, router, route) {
        this.http = http;
        this.router = router;
        this.route = route;
        this.searchTask = {};
    ...
    TaskmanagerComponent.prototype.searchTaskDetails = function () {
        var _this = this;
    ...
    TaskmanagerComponent.prototype.clearsearchDetails = function () {
        var _this = this;
        this.searchTask = {};
        this.http.get('/tasks').subscribe(function (data) {
            _this.tasks = data;
    ...
    TaskmanagerComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./taskmanager.component.html */ "./src/app/taskmanager/taskmanager.component.html"),
            styles: [__webpack_require__(/*! ./taskmanager.component.css */ "./src/app/taskmanager/taskmanager.component.css")]
        }),
...
module.exports = "<div class=\"container\">\n<h1>{{ task.taskName}} </h1>\n <h4><a [routerLink]=\"['/taskmanager']\">Go Back</a></h4>\n<dl class=\"list\">\n <dt>Priority</dt>\n <dd>{{ task.priority }}</dd>\n <dt>Parent</dt>\n <dd>{{ task.parentTaskName }}</dd>\n <dt>Start Date</dt>\n <dd><time>{{ task.startDate | amDateFormat: 'YYYY-MM-DD' }}</time></dd>\n <dt>End Date</dt>\n <dd><time>{{ task.endDate  | amDateFormat: 'YYYY-MM-DD' }}</time></dd>\n\n</dl>\n</div>"
...
var ViewtaskComponent = /** @class */ (function () {
    ...
    ViewtaskComponent.prototype.getTaskDetail = function (id) {
        var _this = this;
        this.http.get('/tasks/' + id).subscribe(function (data) {
            _this.task = data;
            _this.updateStartDateFormat(_this.task);
    ...
    ViewtaskComponent.prototype.updateStartDateFormat = function (task) {
        task.startDate = this.datePipe.transform(task.startDate, "yyyy-MM-dd");
    };
...
module.exports = __webpack_require__(/*! C:\Users\Admin\Downloads\TaskManager\frontend\src\main.ts */"./src/main.ts");
